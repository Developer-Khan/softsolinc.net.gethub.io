...
if(!class_exists('Slide_Widget_Free')){
	class Slide_Widget_Free extends \Elementor\Widget_Base {
	    ...
	    public function get_title() {
	        return esc_html__( 'TF Simple Slider', 'themesflat-elementor' );
	    }
		...
		protected function _register_controls() {
			/* Start Slide Setting*/
				...
				$this->add_control( 'vegas_slideshow_style',
		            [
		                'label' => esc_html__( 'Slide Style', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::SELECT,
		                'default' => 'slidehero',
		                'options' => [
		                    'slidehero' => esc_html__( 'Image Slider', 'themesflat-elementor' ),
		                    'slidevideo' => esc_html__( 'Video Slider', 'themesflat-elementor' ),                    
		                ],
		            ]
		        );
		        $this->add_control(
		            ...
		            [
		                ...
		                'options' => [
		                    'full-height' => esc_html__( 'Full Height', 'themesflat-elementor' ),
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Custom Height Tablet', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px' ],
						'range' => [
							'px' => [
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Custom Height Mobile', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px' ],
						'range' => [
							'px' => [
		        ...
		        $this->add_control( 'effect',
		            [
		                'label' => esc_html__( 'Effects', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::SELECT,
		                'default' => 'slideRight',
		                'options' => [
		                    'fade' => esc_html__( 'Fade', 'themesflat-elementor' ),
		                    'fade2' => esc_html__( 'Fade2', 'themesflat-elementor' ),
		                    'slideLeft' => esc_html__( 'Slide Left', 'themesflat-elementor' ),
		                    'slideLeft2' => esc_html__( 'Slide Left2', 'themesflat-elementor' ),
		                    'slideRight' => esc_html__( 'Slide Right', 'themesflat-elementor' ),
		                    'slideRight2' => esc_html__( 'Slide Right2', 'themesflat-elementor' ),
		                    'slideUp' => esc_html__( 'Slide Up', 'themesflat-elementor' ),
		                    'slideDown' => esc_html__( 'Slide Down', 'themesflat-elementor' ),
		                    'slideDown2' => esc_html__( 'Slide Down2', 'themesflat-elementor' ),
		                    'zoomIn' => esc_html__( 'Zoom In', 'themesflat-elementor' ),
		                    'zoomIn2' => esc_html__( 'Zoom In2', 'themesflat-elementor' ),
		                    'zoomOut' => esc_html__( 'Zoom Out', 'themesflat-elementor' ),
		                    'zoomOut2' => esc_html__( 'Zoom Out2', 'themesflat-elementor' ),
		                    'swirlLeft' => esc_html__( 'Swirl Left', 'themesflat-elementor' ),
		                    'swirlLeft2' => esc_html__( 'Swirl Left2', 'themesflat-elementor' ),
		                    'swirlRight' => esc_html__( 'Swirl Right', 'themesflat-elementor' ),
		                    'swirlRight2' => esc_html__( 'Swirl Right2', 'themesflat-elementor' ),
		                    'burn' => esc_html__( 'Burn', 'themesflat-elementor' ),
		                    'burn2' => esc_html__( 'Burn2', 'themesflat-elementor' ),
		                    'blur' => esc_html__( 'Blur', 'themesflat-elementor' ),
		                    'blur2' => esc_html__( 'Blur2', 'themesflat-elementor' ),
		                    'flash' => esc_html__( 'Flash', 'themesflat-elementor' ),
		                    'flash2' => esc_html__( 'Flash2', 'themesflat-elementor' )
		                ],
		            ]
		        ); 
		        $this->add_control( 'delay',
		            [
		                'label'   => esc_html__( 'Duration (ms)', 'themesflat-elementor' ),
		        ...
		        $this->add_control( 'pattern_overlay',
		            [
		                'label' => esc_html__( 'Pattern Overlay', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::SELECT,
		                'default' => 'style-1',
		                'options' => [
		                    ''          => esc_html__( 'No Parttern', 'themesflat-elementor' ),
		                    ...
		                    'style-4'   => esc_html__( 'Style 4', 'themesflat-elementor' ),
		                    'style-5'   => esc_html__( 'Style 5', 'themesflat-elementor' ),
		                    'style-6'   => esc_html__( 'Style 6', 'themesflat-elementor' ),
		                    'style-7'   => esc_html__( 'Style 7', 'themesflat-elementor' ),
		                    'style-8'   => esc_html__( 'Style 8', 'themesflat-elementor' ),
		                    'style-9'   => esc_html__( 'Style 9', 'themesflat-elementor' ),
		                ],
		            ]
		        );
		        $this->add_control( 'color_overlay',
		            [
		                'label'     => esc_html__( 'Color Overlay', 'themesflat-elementor' ),
		        ...
		        $this->add_control( 'content_top',
		            [
		                'label'   => esc_html__( 'Content: Top Margin', 'themesflat-elementor' ),
		                'type'    => \Elementor\Controls_Manager::TEXT,
		                'default' => '',
		                'placeholder' => esc_html__( '50', 'themesflat-elementor' ),
		                'description' => esc_html__('Ex: 50. In case you want to set a spacing above the content area.', 'themesflat-elementor')                    
		            ]
		        );
		        $this->add_control( 'content_into_grid',
		            [
		                'label'         => esc_html__( 'Content Area Into Grid?', 'themesflat-elementor' ),
		        ...
		        $this->add_control( 'content_container',
					[
						'label' => esc_html__( 'Content Area Container Width', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px' ],
						'range' => [
							'px' => [
		        ...
		        $this->add_control('vegas_slideshow_list',
		            [
		                'label'  => esc_html__('Image Slides','themesflat-elementor'),
		        ...
		        $this->add_control( 'video_link',
		            [
		                'label'   => esc_html__( 'Youtube link (URL)', 'themesflat-elementor' ),
		                'type'    => \Elementor\Controls_Manager::TEXT,
		                'default' => 'https://www.youtube.com/watch?v=r0FAQ7yjOzA&t=7s',
		                'description' => esc_html__( 'Youtube link or ID. Ex: https://www.youtube.com/watch?v=r0FAQ7yjOzA&t=7s', 'themesflat-elementor' ),
		                'condition' => [
	        ...
	        /* Start Scroll Anchor Content*/
	        	$this->start_controls_section('section_slider_scroll_anchor',
		            [
		                'label'         => esc_html__('Scroll Anchor','themesflat-elementor'),
		            ]
		        );
		        $this->add_control( 'arrow_anchor',
		            [
		                'label'         => esc_html__( 'Arrow Anchor', 'themesflat-elementor' ),
		                'type'          => \Elementor\Controls_Manager::SWITCHER,
		                'label_on'      => esc_html__( 'On', 'themesflat-elementor' ),
		                'label_off'     => esc_html__( 'Off', 'themesflat-elementor' ),
		                'return_value'  => 'yes',
		        ...
		        $this->add_control( 'arrow_anchor_svg_width',
					[
						'label' => __( 'Width Icon SVG', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px', 'em' ],
						'range' => [
							'px' => [
				...
				$this->add_control( 'arrow_anchor_font_size',
					[
						'label' => __( 'Size', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px'],
						'range' => [
							'px' => [
		        ...
		        $this->add_control( 'arrow_style',
		            [
		                'label' => esc_html__( 'Arrow Style', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::SELECT,
		                'default' => 'default',
		                'options' => [
		                    'default'   => esc_html__( 'Default', 'themesflat-elementor' ),
		                    'outline-circle'   => esc_html__( 'Outline Circle', 'themesflat-elementor' ),
		                    'outline-square'   => esc_html__( 'Outline Square', 'themesflat-elementor' ),
		                ],
		                'condition' => [
		                    'arrow_anchor[value]' => 'yes',
		                ]
		        ...
		        $this->add_control( 'scroll_id',
		            [
		                'label'   => esc_html__( 'Scroll to Row (ID)', 'themesflat-elementor' ),
		                'type'    => \Elementor\Controls_Manager::TEXT,
		                'default' => '',
		                'condition' => [
		                    'arrow_anchor[value]' => 'yes',
	        ...
	        /* Start Slide Content*/
		        $this->start_controls_section('section_content_hero',
		            [
		                'label'         => esc_html__('Slide Content','themesflat-elementor'),
		            ]
		        );
		        $this->add_control( 'animation_heading',
		            [
		                'label' => esc_html__( 'Animation Heading', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::SELECT,
		                'default' => 'none',
		                'options' => [
		                	'none' => esc_html__( 'None', 'themesflat-elementor' ),
		                    'type' => esc_html__( 'Typing', 'themesflat-elementor' ),
		                    'scroll' => esc_html__( 'Scrolling', 'themesflat-elementor' ),
		                ],
		            ]
		        );
		        $this->add_control('prefix_title_text',
		        	[
		                'label'   => esc_html__( 'Prefix Title', 'themesflat-elementor' ),
		                'type'    => \Elementor\Controls_Manager::TEXT,
		                'label_block' => true,
		                'default' => '',                
		            ]
		    	...
		    	$this->add_control('suffix_title_text',
		        	[
		                'label'   => esc_html__( 'Suffix Title', 'themesflat-elementor' ),
		                'type'    => \Elementor\Controls_Manager::TEXT,
		                'label_block' => true,
		                'default' => '',                
		            ]
		    	...
		    	$this->add_control( 'sub_title_position',
					[
						'label' => __( 'Position Sub Title', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::CHOOSE,
						'default' => 'bottom',
						'options' => [
							'top' => [
								'title' => __( 'Before Title', 'themesflat-elementor' ),
								'icon' => 'eicon-v-align-top',
							],
							'bottom' => [
								'title' => __( 'After Title', 'themesflat-elementor' ),
		        ...
		        $this->add_control('vegas_desc_text',
		        	[
		            'label'         => esc_html__('Desciption','themesflat-elementor'),
		            'type'        => \Elementor\Controls_Manager::TEXTAREA,
	        ...
	        /* Start Button Setting */
		        $this->start_controls_section('section_button_setting_simple_slide',
		            [
		                'label'         => esc_html__('Buttons','themesflat-elementor'),
		            ]
		        );
		        $repeater = new \Elementor\Repeater();
		        $repeater->start_controls_tabs( 'button_tabs' );
		        	$repeater->start_controls_tab( 'button_content_tab',
				        ...
				        $repeater->add_control( 'btn_url', 
				        	[
				                'label' => esc_html__( 'Button URL', 'themesflat-elementor' ),
				        ...
				        $repeater->add_control( 'icon_button_align',
							[
								...
								'options' => [
									'btn-icon-left' => esc_html__( 'Before', 'themesflat-elementor' ),
									'btn-icon-right' => esc_html__( 'After', 'themesflat-elementor' ),
								],
								'condition' => [
									'btn_icon[value]!' => '',
								],
						...
						$repeater->add_control( 'icon_indent_left',
							[
								'label' => esc_html__( 'Icon Spacing Left', 'themesflat-elementor' ),
								'type' => \Elementor\Controls_Manager::SLIDER,
								'range' => [
									'px' => [
										'max' => 50,
						...
						$repeater->add_control( 'icon_indent_right',
							[
								'label' => esc_html__( 'Icon Spacing Right', 'themesflat-elementor' ),
								'type' => \Elementor\Controls_Manager::SLIDER,
								'range' => [
									'px' => [
										'max' => 50,
			        ...
			        $repeater->start_controls_tab( 'style_hover_btn',
				        ...
				        $repeater->add_control( 'hover_font_color', 
				        	[
				                'label' => esc_html__( 'Font Color', 'themesflat-elementor' ),
				                'type' => \Elementor\Controls_Manager::COLOR,
				                'default' => '#ffffff',
				                'selectors' => array(
		        ...
		        $this->add_control('create_buttons',
		            [
		                'label'  => esc_html__('Create buttons','themesflat-elementor'),
		                'type'   => \Elementor\Controls_Manager::REPEATER,
		                'fields' => $repeater->get_controls(),
	        ...
	        /* Start Tab Text Style */
				...
				$this->add_control( 'prefix_color',
		            [
		                'label' => esc_html__( 'Color Prefix', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::COLOR,
		                'default' => '#ffffff',
		                'selectors' => [
				...
				$this->add_responsive_control(
					'spacing_prefix',
					[
						'label' => esc_html__( 'Spacing Prefix', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px' ],
						'range' => [
							'px' => [
		        ...
		        $this->add_control( 'suffix_color',
		            [
		                'label' => esc_html__( 'Color Suffix', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::COLOR,
		                'default' => '#ffffff',
		                'selectors' => [
				...
				$this->add_responsive_control(
					'spacing_suffix',
					[
						'label' => esc_html__( 'Spacing Suffix', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px' ],
						'range' => [
							'px' => [
		        ...
		        $this->add_group_control(
		            ...
		            [
		                ...
		                'label' => esc_html__( 'Typography Title', 'themesflat-elementor' ),
				...
				$this->add_responsive_control( 
					'margin_title',
					[
						'label' => esc_html__( 'Margin Title', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em' ],
						'default' => 	[
											'top' => 0,
		        ...
		        $this->add_control( 'sub_title_color',
		            [
		                'label' => esc_html__( 'Color Sub Title', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::COLOR,
		                'default' => '#ffffff',
		                'selectors' => [
		        ...
		        $this->add_group_control(
		            ...
		            [
		                ...
		                'label' => esc_html__( 'Typography Sub Title', 'themesflat-elementor' ),
		                'selector' => '{{WRAPPER}} .vegas-content .sub-title',
		            ]
		        );
		        $this->add_control( 'width_sub_title',
					[
						'label' => esc_html__( 'Width Sub Title', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px', '%' ],
						'range' => [
							'px' => [
				...
				$this->add_responsive_control( 
					'margin_sub_title',
					[
						'label' => esc_html__( 'Margin Sub Title', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em' ],
						'default' => 	[
											'top' => 0,
		        ...
		        $this->add_control( 'desc_color',
		            [
		                'label' => esc_html__( 'Color Desciption', 'themesflat-elementor' ),
		                'type' => \Elementor\Controls_Manager::COLOR,
		                'default' => '#ffffff',
		                'selectors' => [
		        ...
		        $this->add_group_control(
		            ...
		            [
		                ...
		                'label' => esc_html__( 'Typography Desciption', 'themesflat-elementor' ),
		                'selector' => '{{WRAPPER}} .vegas-content .desc',
		            ]
		        );
		        $this->add_control( 'width_desc',
					[
						'label' => esc_html__( 'Width Desciption', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px', '%' ],
						'range' => [
							'px' => [
				...
				$this->add_responsive_control( 
					'margin_desc',
					[
						'label' => esc_html__( 'Margin Desciption', 'themesflat-elementor' ),
						'type' => \Elementor\Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em' ],
						'default' => 	[
											'top' => 0,
